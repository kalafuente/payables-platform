  ...
  return (
    <Card>
      <div className="flex items-center justify-between px-5 py-3 border-b border-line">
        <h2 className="text-sm font-medium text-ink-muted">Recent Activity</h2>
        <Link
          href="/bills"
        ...
        <div>
          {entries.map(entry => (
            <Link
              ...
              className="flex items-start gap-3 px-5 py-3 border-b border-line last:border-b-0 hover:bg-canvas transition-colors duration-100"
            >
              <div
                className={cn(
